package ru.artemaa.finances.personal.web.operation;
...
import ru.artemaa.finances.personal.entity.Operation;
import ru.artemaa.finances.personal.entity.OperationType;
import ru.artemaa.finances.personal.entity.Stock;
    ...
    protected void postInit() {
        ...
        if (PersistenceHelper.isNew(getItem())) {
            operationType.addValueChangeListener(e -> {
                ...
                if (isPortfolioAndStockSet() && type == OperationType.Dividends) {
