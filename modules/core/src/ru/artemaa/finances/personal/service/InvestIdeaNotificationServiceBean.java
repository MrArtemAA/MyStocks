...
import ru.artemaa.finances.personal.entity.InvestIdea;
    ...
    private EmailInfo getEmailInfo(List<InvestIdea> investIdeas) {
        ...
        if (CollectionUtils.isEmpty(investIdeas)) {
            return new EmailInfo(
                    ...
                    null,
                    "ru/artemaa/finances/personal/mailtemplates/no-invest-ideas.html",
                    templateParams);
            ...
            return new EmailInfo(
                    ...
                    null,
                    "ru/artemaa/finances/personal/mailtemplates/invest-ideas-summary.html",
                    templateParams);
        }
    }
}